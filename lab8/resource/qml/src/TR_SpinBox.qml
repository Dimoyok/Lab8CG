...
Item {
    ...
    property real singlestep: 0.001

    property bool changeEnabled: false;
    property bool upEnabled: (value != maximumValue) && changeEnabled;
    property bool downEnabled: (value != minimumValue) && changeEnabled;
    ...
    TextInput {
        ...
        onTextChanged: { spinbox.setValue(text); /*spinbox.valueChanged();*/ }
        color: textColor
    ...
    Loader {
        ...
        MouseArea {
            ...
            onClicked: if(upButton.enabled) increment()

            property bool autoincrement: false;
            onReleased: spinbox.valueChanged(), autoincrement = false
    ...
    Loader {
        ...
        MouseArea {
            ...
            onClicked: if(downButton.enabled) decrement()
